...
logger = get_logger("penflow.agents.mcp_server_attack")
...
class MCPServerAttackAgent(BaseCapabilityAgent):
    """
    ...
    def __init__(self, priority: int = 10):
        super().__init__(agent_name="MCPServerAttackAgent", priority=priority)
...
MCPServerAgent = MCPServerAttackAgent
