...
class MarkdownReportGenerator:
    ...
    def generate_report(self, target_domain: str, knowledge_store: KnowledgeStore,
        ...
        report_lines = [
            ...
            "",
            f"- **{len(assets)} assets** discovered via Certificate Transparency, DNS, and crawling",
            f"- **{len(obs)} observations** recorded across all recon channels",
            f"- **{len(plan.ordered_hypotheses)} hypotheses** generated and prioritized",
            f"- **{len(verified_findings)} findings** verified through adversarial critic engine",
            "",
            "---",
            "",
        ]
