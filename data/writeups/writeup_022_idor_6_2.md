# Bug Bounty Research Report #022: Broken Object Level Authorization (BOLA / IDOR) on Spring Boot
...
The target application deployed on `Spring Boot` exposed `/api/v2/messages/{msg_id}`.
