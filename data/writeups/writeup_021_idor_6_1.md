# Bug Bounty Research Report #021: Broken Object Level Authorization (BOLA / IDOR) on Node.js
...
The target application deployed on `Node.js` exposed `/api/v2/messages/{msg_id}`.
