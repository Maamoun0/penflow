# Bug Bounty Research Report #038: Broken Function Level Authorization (BFLA) on Spring Boot
...
The target application deployed on `Spring Boot` exposed `/api/v1/admin/roles/assign`.
