# Bug Bounty Research Report #008: Broken Object Level Authorization (BOLA / IDOR) on Django
...
The target application deployed on `Django` exposed `/api/v2/accounts/{uuid}/settings`.
