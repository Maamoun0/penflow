# Bug Bounty Research Report #010: Broken Object Level Authorization (BOLA / IDOR) on Spring Boot
...
The target application deployed on `Spring Boot` exposed `/api/v1/orders/{order_id}/invoice`.
