# Bug Bounty Research Report #048: Broken Function Level Authorization (BFLA) on Django
...
The target application deployed on `Django` exposed `/api/v1/admin/feature-flags`.
