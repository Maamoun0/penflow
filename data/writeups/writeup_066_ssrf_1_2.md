# Bug Bounty Research Report #066: Server-Side Request Forgery (SSRF) on Spring Boot
...
The target application deployed on `Spring Boot` exposed `/api/v1/render/pdf?url=`.
