# Bug Bounty Research Report #001: Broken Object Level Authorization (BOLA / IDOR) on Node.js
...
The target application deployed on `Node.js` exposed `/api/v1/users/{id}/profile`.
