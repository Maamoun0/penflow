# Bug Bounty Research Report #019: Broken Object Level Authorization (BOLA / IDOR) on Express
...
The target application deployed on `Express` exposed `/api/v1/billing/{account_id}/payment-methods`.
