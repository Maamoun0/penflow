# Bug Bounty Research Report #053: Broken Function Level Authorization (BFLA) on Node.js
...
The target application deployed on `Node.js` exposed `/api/v1/users/{id}/promote-admin`.
