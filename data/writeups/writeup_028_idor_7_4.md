# Bug Bounty Research Report #028: Broken Object Level Authorization (BOLA / IDOR) on Django
...
The target application deployed on `Django` exposed `/api/v1/tickets/{ticket_id}/attachments`.
