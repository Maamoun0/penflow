# Bug Bounty Research Report #050: Broken Function Level Authorization (BFLA) on Spring Boot
...
The target application deployed on `Spring Boot` exposed `/api/v2/audit/logs/purge`.
