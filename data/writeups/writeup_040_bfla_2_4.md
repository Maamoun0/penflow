# Bug Bounty Research Report #040: Broken Function Level Authorization (BFLA) on Django
...
The target application deployed on `Django` exposed `/api/v1/admin/roles/assign`.
