# Bug Bounty Research Report #012: Broken Object Level Authorization (BOLA / IDOR) on Django
...
The target application deployed on `Django` exposed `/api/v1/orders/{order_id}/invoice`.
