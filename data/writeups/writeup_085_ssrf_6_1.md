# Bug Bounty Research Report #085: Server-Side Request Forgery (SSRF) on Node.js
...
The target application deployed on `Node.js` exposed `/api/v2/proxy/request?endpoint=`.
