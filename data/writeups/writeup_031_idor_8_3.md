# Bug Bounty Research Report #031: Broken Object Level Authorization (BOLA / IDOR) on Express
...
The target application deployed on `Express` exposed `/api/v2/contracts/{contract_id}`.
