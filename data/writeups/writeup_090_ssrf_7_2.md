# Bug Bounty Research Report #090: Server-Side Request Forgery (SSRF) on Spring Boot
...
The target application deployed on `Spring Boot` exposed `/api/v1/crawler/extract?link=`.
