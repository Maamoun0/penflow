# Bug Bounty Research Report #198: OAuth 2.0 & JWT Security Flaws on Spring Boot
...
The target application deployed on `Spring Boot` exposed `/oauth/authorize?redirect_uri=`.
