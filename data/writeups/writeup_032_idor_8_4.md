# Bug Bounty Research Report #032: Broken Object Level Authorization (BOLA / IDOR) on Django
...
The target application deployed on `Django` exposed `/api/v2/contracts/{contract_id}`.
