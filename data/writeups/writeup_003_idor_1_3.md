# Bug Bounty Research Report #003: Broken Object Level Authorization (BOLA / IDOR) on Express
...
The target application deployed on `Express` exposed `/api/v1/users/{id}/profile`.
