# Bug Bounty Research Report #029: Broken Object Level Authorization (BOLA / IDOR) on Node.js
...
The target application deployed on `Node.js` exposed `/api/v2/contracts/{contract_id}`.
