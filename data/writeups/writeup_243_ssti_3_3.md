# Bug Bounty Research Report #243: Server-Side Template Injection (SSTI) on Express
...
The target application deployed on `Express` exposed `/api/v1/pdf/generate?template=`.
