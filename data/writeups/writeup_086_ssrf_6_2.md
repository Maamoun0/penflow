# Bug Bounty Research Report #086: Server-Side Request Forgery (SSRF) on Spring Boot
...
The target application deployed on `Spring Boot` exposed `/api/v2/proxy/request?endpoint=`.
