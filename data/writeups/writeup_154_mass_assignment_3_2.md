# Bug Bounty Research Report #154: Mass Assignment / Auto-Binding on Spring Boot
...
The target application deployed on `Spring Boot` exposed `/api/v1/account/settings`.
