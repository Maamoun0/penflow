# Bug Bounty Research Report #018: Broken Object Level Authorization (BOLA / IDOR) on Spring Boot
...
The target application deployed on `Spring Boot` exposed `/api/v1/billing/{account_id}/payment-methods`.
